...
- `minns vibe-graph "<intent>" --stage roles` — Stage 1: identify roles
- `minns vibe-graph "<intent>" --stage structure` — Stage 2: design structure
- `minns vibe-graph "<intent>"` — Full pipeline
- `minns vibe-graph --from-template <name>` — start from template
- `minns strategies "<query>"` — find proven patterns
