...
- `eventgraph workflow status <id>` — check workflow state
- `eventgraph workflow run <id>` — get next ready steps
- `eventgraph workflow step-complete <id> <step_id> --result "..."` — report step completion
- `eventgraph learn "..." --category workflow_result` — capture outcomes
