---
name: learn
description: Store a learning into EventGraphDB for cross-session recall
user_invocable: true
---

# /learn — Store a Learning

Explicitly store a learning, decision, pattern, or insight into the EventGraphDB knowledge graph for recall in future sessions.
...
```bash
eventgraph learn "<content>" --category <detected_category> --tags <relevant_tags>
```
...
3. Run the `eventgraph learn` command with detected category and tags
