//! `eventgraph converse` — send conversation events to the graph.
//!
//! Supports three modes:
//! - Single message: `eventgraph converse "user said this"`
//! - File: `eventgraph converse --file conversation.jsonl`
//! - Stdin: `cat conversation.jsonl | eventgraph converse --from-stdin`
//!
...
pub async fn execute(client: &EventGraphClient, args: ConverseArgs) -> Result<()> {
    let session_id = args
        .session_id
