...
impl CausalityTracker {
    ...
    pub fn add_causality(&mut self, child: EventId, parent: EventId, child_timestamp: Timestamp) -> DatabaseResult<()> {
    ...
    fn has_cycle_util(&self, event_id: EventId, visited: &mut HashSet<EventId>, rec_stack: &mut HashSet<EventId>) -> bool {
