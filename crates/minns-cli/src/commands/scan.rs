//! `minns scan` — scan a codebase and ingest all files into MinnsDB.
//!
...
//!
//! Usage:
//!   minns scan .                          # Scan current directory
//!   minns scan src/ --language rust        # Force language
//!   minns scan . --repo my-project         # Tag with repository name
//!   minns scan . --ext rs,py              # Only specific extensions
//!   minns scan . --dry-run                # Show what would be scanned
...
pub async fn execute(client: &MinnsDBClient, args: ScanArgs) -> Result<()> {
