//! `minns vibe-graph` — query the graph for workflow design context.
//!
...
//!
//! Usage:
//!   minns vibe-graph "Review PR and write tests"       # Get design context
//!   minns vibe-graph "Review PR" --json                # JSON for programmatic use
...
pub async fn execute(client: &MinnsDBClient, args: VibeGraphArgs) -> Result<()> {
