//! `minns code-search` — search code entities in the graph.
//!
//! Usage:
//!   minns code-search parse_rust             # Find by name
//!   minns code-search --kind function         # All functions
//!   minns code-search --language rust          # All Rust entities
//!   minns code-search --file "src/main*"       # By file pattern
...
pub async fn execute(client: &MinnsDBClient, args: CodeSearchArgs) -> Result<()> {
    let resp = client
        .search_code(
