...
export class StrategiesView {
    ...
    applyFilter() {
        const agentInput = document.getElementById('strategies-agent-filter');
        if (agentInput) {
        ...
        <div class="strategy-item" onclick="window.strategiesView?.showStrategyDetails(${strategy.id})">
          ...
          <div class="strategy-body">
            ...
            <div class="strategy-steps-preview">
              ${strategy.reasoning_steps.slice(0, 3).map(step => `<div class="step-preview">${step.sequence_order + 1}. ${step.description.substring(0, 50)}...</div>`).join('')}
        ...
        <div class="detail-content">
          ...
          <div class="detail-section">
            ...
            <ol class="reasoning-steps">
              ${strategy.reasoning_steps.map(step => `<li><div class="step-description">${step.description}</div></li>`).join('')}
            </ol>
          </div>
        </div>
      `;
